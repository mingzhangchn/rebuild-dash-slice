                    ...
                    if (memcmp(&(tempBuf[4]), "avc1", 4) == 0){
                        ...
                        if (memcmp(&(buf[4]), "avcC", 4) == 0){     
                            ...
                            if ( (avccBuf[5] & 0x1f) == 0x01){
                                int sequenceParameterSetLength = ((int)avccBuf[6]) << 8 | avccBuf[7];
                                unsigned char sequenceParameterSet[sequenceParameterSetLength];
                                ...
                                int pictureParameterSetLength = ((int)avccBuf[p_offset+1]) << 8 | avccBuf[p_offset+2];
                                unsigned char pictureParameterSet[pictureParameterSetLength];
